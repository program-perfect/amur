...
export const conversations: Conversation[] = [
...

  {
    ...
    name: "Алексей",
    nameDative: "Алексею",
    avatar: "/profiles/aleksey-main.png",
    photos: ["/profiles/aleksey-main.png"],
    online: false,
    status: "Был в сети 22 минут назад",
    verified: true,
    city: "Артемьевск",
    distance: "4 км",
    compatibility: 85,
    about:
      "Я умею слушать, чувствовать настроение и делать так, чтобы рядом со мной женщина улыбалась. Не люблю грубость, суету и пустые слова. Мне ближе искренний интерес, красивое общение и отношения, в которых есть и нежность, и огонь.",
    facts: [
      { icon: MapPin, label: "Артемьевск · 4 км от вас" },
      { icon: Ruler, label: "191 см" },
    ],
    interests: [
      { label: "Рестораны", icon: Film },
      { label: "Музыка", icon: Footprints },
      { label: "Поездки", icon: Coffee },
      { label: "Общение", icon: Coffee },
    ],
