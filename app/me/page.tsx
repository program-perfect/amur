        ...
        <div className="grid gap-6 xs:gap-8 md:grid-cols-[320px_1fr] lg:grid-cols-[400px_1fr]">
          <div className="md:sticky md:top-24 md:self-start">
            <button
              ...
              className="
                group relative w-full cursor-zoom-in overflow-hidden rounded-3xl text-left
                shadow-[0_1px_2px_rgba(120,50,20,0.04),0_20px_50px_-18px_rgba(120,50,20,0.25)]
                ring-1 ring-border
                h-[min(68dvh,720px)]
                xs:h-[min(72dvh,760px)]
                md:h-[min(78dvh,820px)]
                lg:h-[min(82dvh,900px)]
              "
            >
              <Image
                ...
                alt="Аватар"
                fill
                sizes="(max-width: 767px) 100vw, (max-width: 1279px) 320px, 400px"
                priority
          ...
          <div className="flex flex-col gap-8">
            <section>
              ...
              <p className="text-[15px] leading-relaxed text-foreground/85">
                Ищу серьёзные отношения и создание крепкой семьи. Люблю литературу,
                хорошие книги и долгие разговоры под вечер. Верю, что настоящая любовь
                существует.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-2 xs:grid-cols-3 xs:gap-2.5 md:grid-cols-2 lg:grid-cols-3">
                {photos.map((src, i) => (
                  <button
                    key={src}
                    type="button"
